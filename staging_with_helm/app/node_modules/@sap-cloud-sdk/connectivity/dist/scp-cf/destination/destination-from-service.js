...
class DestinationFromServiceRetriever {
    ...
    get destinationServiceCredentials() {
    ...
    async fetchDestinationByToken(jwt) {
        return (0, destination_service_1.fetchDestination)(this.destinationServiceCredentials.uri, jwt, this.options);
    }
...
Possible alternatives for such technical user authentication are BasicAuthentication, OAuth2ClientCredentials, or ClientCertificateAuthentication`);
    ...
    async addProxyConfiguration(destination) {
        var _a;
        switch ((0, proxy_util_1.proxyStrategy)(destination)) {
            case proxy_util_1.ProxyStrategy.ON_PREMISE_PROXY:
                return (0, connectivity_service_1.addProxyConfigurationOnPrem)(destination, (_a = this.subscriberToken) === null || _a === void 0 ? void 0 : _a.userJwt);
            case proxy_util_1.ProxyStrategy.INTERNET_PROXY:
            case proxy_util_1.ProxyStrategy.PRIVATELINK_PROXY:
                return (0, proxy_util_1.addProxyConfigurationInternet)(destination);
    ...
    async addTrustStoreConfiguration(destination, origin) {
        ...
        if ((_a = destination.originalProperties) === null || _a === void 0 ? void 0 : _a.TrustStoreLocation) {
            const trustStoreCertificate = await (0, destination_service_1.fetchCertificate)(this.destinationServiceCredentials.uri, origin === 'provider'
