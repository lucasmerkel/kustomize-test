...
exports.noDestinationErrorMessage = exports.isDestinationJson = exports.isDestinationConfiguration = exports.parseCertificate = exports.toDestinationNameUrl = exports.getAdditionalQueryParameters = exports.getAdditionalHeaders = exports.getAdditionalHeadersAndQueryParameters = exports.parseDestination = exports.sanitizeDestination = void 0;
...
function validateDestinationConfig(destinationConfig) {
    if (isHttpDestination(destinationConfig) &&
        ...
        const detailedMessage = destinationConfig.Name
            ...
            : '';
        throw Error(`Property 'URL' of destination configuration must not be undefined${detailedMessage}.`);
    }
}
