...
async function getClientCredentialsToken(service, userJwt, options) {
    ...
    const xssecPromise = new Promise((resolve, reject) => {
        xssec.requests.requestClientCredentialsToken(subdomainAndZoneId.subdomain, serviceCredentials, null, subdomainAndZoneId.zoneId, (err, token, tokenResponse) => err ? reject(err) : resolve(tokenResponse));
    });
