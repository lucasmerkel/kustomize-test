 ...
 */
export declare type DestinationProxyType = 'OnPremise' | 'Internet' | 'PrivateLink' | null;
/**
 ...
 */
export declare type DestinationRetrievalOptions = CachingOptions & ResilienceOptions & {
    /**
 ...
 * @internal
 */
export declare function isDestination(destination: any): destination is Destination;
/**
 * Represents the authentication type of a destination.
 */
export declare type AuthenticationType = 'PrincipalPropagation' | 'NoAuthentication' | 'BasicAuthentication' | 'SAMLAssertion' | 'OAuth2SAMLBearerAssertion' | 'OAuth2ClientCredentials' | 'OAuth2UserTokenExchange' | 'ClientCertificateAuthentication' | 'OAuth2JWTBearer' | 'OAuth2Password';
/**
